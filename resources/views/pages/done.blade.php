        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label for="secure-content">Your Content Has Been Sent</label>
                    <textarea type="text" class="form-control" id="secure-content" placeholder="" readonly>
Thanks for using SendCreds.
